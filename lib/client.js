...
export const client = sanityClient({
  ...
  projectId: 'h1g7r4lc', // check project id in manage project homepage
  dataset: 'quebrandooferta', // check dataset name in Datasets tab

  // TODO: try to omit apiVersion
  // To check when a git project was created, run:
  // git log --reverse --format="%ai" | tail -1
  apiVersion: '2023-10-06', // when this project was created
